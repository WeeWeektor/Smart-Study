...
async def get_instance_cached_all(
    ...
    cache_key = await get_cache_key(instance_type, instance_type_cache, cate, level, sort_keys, search_query)
    ...
    if instance_type == "courses":
        ...
        instance_data = await get_courses(cate, level, sort_keys, search_query)
