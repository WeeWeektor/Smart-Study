...
class Test(BaseModel):
    ...
    description = models.TextField(default="", max_length=500, verbose_name=_("Test description"))
    ...
    test_data_ids = models.CharField(max_length=24, unique=True, verbose_name=_("Mongo document ID"))
