...
from users_calendar.services.personal_event_service import GetPersonalEvents
...
class PersonalEventsCache:
    ...
    def __init__(self, user):
        self.user = user
        self.key = f'personal_events:user_{user.id}'
    ...
    async def invalidate_personal_events_cache(self):
